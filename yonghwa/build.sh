...
mv bazel-bin/tensorflow/lite/examples/simple_test/simple_test /host_dir/LiteRT_benchmark/yonghwa

echo -e "${CYAN}Step 4: Changing directory to /host_home/LiteRT_benchmark...${RESET}"
cd /host_dir/LiteRT_benchmark/yonghwa || { echo -e "${RED}Failed to change directory.${RESET}"; exit 1; }
